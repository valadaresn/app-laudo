        ...
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                {activeTab === 'participants' && (
                    <ExpertiseForm register={register} errors={errors} field="participants" />
                )}
                {activeTab === 'procedure' && (
                    <ExpertiseForm register={register} errors={errors} field="procedure" />
                )}
                {activeTab === 'parameters' && (
                    <ExpertiseForm register={register} errors={errors} field="parameters" />
                )}
                {activeTab === 'analysis' && (
                    <ExpertiseForm register={register} errors={errors} field="analysis" />
                )}
                {activeTab === 'briefConclusion' && (
                    <ExpertiseForm register={register} errors={errors} field="briefConclusion" />
                )}
                {activeTab === 'report' && (
